...
// servo controllers
RobotArm::ServoComponentComponentImpl clawServo("clawServo");
RobotArm::ServoComponentComponentImpl baseServo("baseServo");
RobotArm::ServoComponentComponentImpl armHeightServo("armServo");
RobotArm::ServoComponentComponentImpl armLengthServo("clawTiltServo");

// arm demo component
RobotArm::RobotArmComponentImpl armDemo("armDemo");
...
void constructApp(int port_number, char* hostname) {
    ...
    clawServo.setServoNumber(0);
    baseServo.setServoNumber(1);
    armHeightServo.setServoNumber(2);
    armLengthServo.setServoNumber(3);
    // configure card with one of the servos
    clawServo.configurePiHatBoard();
